...
#include "c_includes/C_CkSshKey.h"
...
func NewSshKey() *SshKey {
	return &SshKey{C.CkSshKey_Create()}
}

func (z *SshKey) DisposeSshKey() {
    if z != nil {
	C.CkSshKey_Dispose(z.ckObj)
	}
}
...
// present.
func (z *SshKey) Comment() string {
    return C.GoString(C.CkSshKey_comment(z.ckObj))
}
// property setter: Comment
func (z *SshKey) SetComment(goStr string) {
    cStr := C.CString(goStr)
    C.CkSshKey_putComment(z.ckObj,cStr)
...
//
func (z *SshKey) DebugLogFilePath() string {
    return C.GoString(C.CkSshKey_debugLogFilePath(z.ckObj))
}
// property setter: DebugLogFilePath
func (z *SshKey) SetDebugLogFilePath(goStr string) {
    cStr := C.CString(goStr)
    C.CkSshKey_putDebugLogFilePath(z.ckObj,cStr)
    C.free(unsafe.Pointer(cStr))
}
...
// key.
func (z *SshKey) IsDsaKey() bool {
    v := int(C.CkSshKey_getIsDsaKey(z.ckObj))
    return v != 0
}

// property: IsPrivateKey
// true if the object contains a private key. false if it contains a public
// key.
func (z *SshKey) IsPrivateKey() bool {
    v := int(C.CkSshKey_getIsPrivateKey(z.ckObj))
    return v != 0
}
...
// key.
func (z *SshKey) IsRsaKey() bool {
    v := int(C.CkSshKey_getIsRsaKey(z.ckObj))
    return v != 0
}
...
func (z *SshKey) KeyType() string {
    return C.GoString(C.CkSshKey_keyType(z.ckObj))
}
...
func (z *SshKey) LastErrorHtml() string {
    return C.GoString(C.CkSshKey_lastErrorHtml(z.ckObj))
}
...
func (z *SshKey) LastErrorText() string {
    return C.GoString(C.CkSshKey_lastErrorText(z.ckObj))
}
...
// method call returns a value indicating failure, or behaves unexpectedly, examine
// this property to get more information.
func (z *SshKey) LastErrorXml() string {
    return C.GoString(C.CkSshKey_lastErrorXml(z.ckObj))
}
...
//
func (z *SshKey) LastMethodSuccess() bool {
    v := int(C.CkSshKey_getLastMethodSuccess(z.ckObj))
    return v != 0
}
// property setter: LastMethodSuccess
func (z *SshKey) SetLastMethodSuccess(value bool) {
    v := C.int(0)
    if value {
            v = C.int(1)
    }
    C.CkSshKey_putLastMethodSuccess(z.ckObj,v)
}

// property: Password
// The password to be used when importing or exporting encrypted private keys.
func (z *SshKey) Password() string {
    return C.GoString(C.CkSshKey_password(z.ckObj))
}
// property setter: Password
func (z *SshKey) SetPassword(goStr string) {
    cStr := C.CString(goStr)
    C.CkSshKey_putPassword(z.ckObj,cStr)
    C.free(unsafe.Pointer(cStr))
}
...
//
func (z *SshKey) UncommonOptions() string {
    return C.GoString(C.CkSshKey_uncommonOptions(z.ckObj))
}
// property setter: UncommonOptions
func (z *SshKey) SetUncommonOptions(goStr string) {
    cStr := C.CString(goStr)
    C.CkSshKey_putUncommonOptions(z.ckObj,cStr)
    C.free(unsafe.Pointer(cStr))
}
...
func (z *SshKey) VerboseLogging() bool {
    v := int(C.CkSshKey_getVerboseLogging(z.ckObj))
    return v != 0
}
// property setter: VerboseLogging
func (z *SshKey) SetVerboseLogging(value bool) {
    v := C.int(0)
    if value {
            v = C.int(1)
    }
    C.CkSshKey_putVerboseLogging(z.ckObj,v)
}

// property: Version
// Version of the component/library, such as "9.5.0.63"
func (z *SshKey) Version() string {
    return C.GoString(C.CkSshKey_version(z.ckObj))
}
...
// -----END RSA PRIVATE KEY-----
func (z *SshKey) FromOpenSshPrivateKey(arg1 string) bool {
    cstr1 := C.CString(arg1)

    v := C.CkSshKey_FromOpenSshPrivateKey(z.ckObj, cstr1)
...
func (z *SshKey) FromOpenSshPublicKey(arg1 string) bool {
    cstr1 := C.CString(arg1)

    v := C.CkSshKey_FromOpenSshPublicKey(z.ckObj, cstr1)
...
func (z *SshKey) FromPuttyPrivateKey(arg1 string) bool {
    cstr1 := C.CString(arg1)

    v := C.CkSshKey_FromPuttyPrivateKey(z.ckObj, cstr1)
...
// zg==
// ---- END SSH2 PUBLIC KEY ----
func (z *SshKey) FromRfc4716PublicKey(arg1 string) bool {
    cstr1 := C.CString(arg1)

    v := C.CkSshKey_FromRfc4716PublicKey(z.ckObj, cstr1)
...
// _LT_/RSAKeyValue>
//
func (z *SshKey) FromXml(arg1 string) bool {
    cstr1 := C.CString(arg1)

    v := C.CkSshKey_FromXml(z.ckObj, cstr1)
...
func (z *SshKey) GenerateDsaKey(arg1 int) bool {

    v := C.CkSshKey_GenerateDsaKey(z.ckObj, C.int(arg1))
...
//
func (z *SshKey) GenerateEcdsaKey(arg1 string) bool {
    cstr1 := C.CString(arg1)

    v := C.CkSshKey_GenerateEcdsaKey(z.ckObj, cstr1)
...
func (z *SshKey) GenerateEd25519Key() bool {

    v := C.CkSshKey_GenerateEd25519Key(z.ckObj)
...
//
func (z *SshKey) GenerateRsaKey(arg1 int, arg2 int) bool {

    v := C.CkSshKey_GenerateRsaKey(z.ckObj, C.int(arg1), C.int(arg2))
...
func (z *SshKey) GenFingerprint() *string {

    retStr := C.CkSshKey_genFingerprint(z.ckObj)
...
// return a string or nil if failed.
func (z *SshKey) LoadText(arg1 string) *string {
    cstr1 := C.CString(arg1)

    retStr := C.CkSshKey_loadText(z.ckObj, cstr1)
...
func (z *SshKey) SaveText(arg1 string, arg2 string) bool {
    cstr1 := C.CString(arg1)
    cstr2 := C.CString(arg2)

    v := C.CkSshKey_SaveText(z.ckObj, cstr1, cstr2)
...
// -----END RSA PRIVATE KEY-----
// return a string or nil if failed.
func (z *SshKey) ToOpenSshPrivateKey(arg1 bool) *string {
    b1 := C.int(0)
    if arg1 {
        b1 = C.int(1)
    }

    retStr := C.CkSshKey_toOpenSshPrivateKey(z.ckObj, b1)
...
// IZDEUQYvVA71Fawp4cqizg==
// return a string or nil if failed.
func (z *SshKey) ToOpenSshPublicKey() *string {

    retStr := C.CkSshKey_toOpenSshPublicKey(z.ckObj)
...
// Private-MAC: 3BE4CAA1B2AE19C3E6841639BD7275019CF961F1
// return a string or nil if failed.
func (z *SshKey) ToPuttyPrivateKey(arg1 bool) *string {
    b1 := C.int(0)
    if arg1 {
        b1 = C.int(1)
    }

    retStr := C.CkSshKey_toPuttyPrivateKey(z.ckObj, b1)
...
// ---- END SSH2 PUBLIC KEY ----
// return a string or nil if failed.
func (z *SshKey) ToRfc4716PublicKey() *string {

    retStr := C.CkSshKey_toRfc4716PublicKey(z.ckObj)
...
//
// return a string or nil if failed.
func (z *SshKey) ToXml() *string {

    retStr := C.CkSshKey_toXml(z.ckObj)
